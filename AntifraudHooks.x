Хорошо. Ниже 5 файлов для замены целиком (4 существующих + 1 новый). После замены: make clean && make package FINALPACKAGE=1.

1. Новый файл — SharedState.h
...
3. WebRTCHooks.x (заменить целиком)
...
4. AntifraudHooks.x (заменить целиком)
