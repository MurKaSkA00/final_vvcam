...
MediaPlaybackUtils_FILES = Tweak.x AntifraudHooks.x BrowserHooks.x JailbreakBypass.x StealthHooks.x WebRTCHooks.x PhotoCaptureHooks.x FrameProcessor.m MediaBufferAdapter.m SharedState.m
